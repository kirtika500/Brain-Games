...
public class user_answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       op1=(RadioButton) findViewById(R.id.bb);
        ...
        aa2.setText(nm);
            ...
            {
          Toast.makeText(user_answer.this,"Error occured!Try Again",Toast.LENGTH_SHORT).show();
            }
                        ...
                        public void onClick(View v) {
                            if(i<5) {
                                ...
                                if (result.equals(cu.getString(6))) {
                                    mark=mark+5;
                                    count++;
                                    Toast.makeText(user_answer.this, "Secured=5", Toast.LENGTH_SHORT).show();
                                }
                                else
                                {
                                    Toast.makeText(user_answer.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
                                }
                                i++;
                               if(k<5)
                               {
                            ...
                            {
                                Intent j=new Intent(user_answer.this,result.class);
                                int id = rg.getCheckedRadioButtonId();
                                res = (RadioButton) findViewById(id);
                             Cursor cu = ob.info_c(i);
                                cu.moveToFirst();
            ...
            skip.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(user_answer.this, "You skipped this question", Toast.LENGTH_SHORT).show();
                            i++;
                            if(k<20)
                            {
                                try {
