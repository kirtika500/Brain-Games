...
import static com.example.braingames.user_dbms.count_dbms;
import static com.example.braingames.user_dbms.mark_dbms;
...
public class result_dbms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        su.setText(sub);
        ff.setText(nm);
        res.setText(""+mark_dbms);
        rq.setText(""+count_dbms);
        int w=5-count_dbms;
        wq.setText(""+w);
        int perc=(mark_dbms*100)/25;
        per.setText(""+perc+"%");}
}
