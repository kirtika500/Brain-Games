...
public class user_dbms extends AppCompatActivity {
    TextView ques,aa1,aa2;
    RadioGroup rg;
    RadioButton op1,op2,op3,op4,res;
    static int mark_dbms=0,count_dbms=0;
    database ob;
    int i=1;
    int k=1;
    Button submit,skip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_dbms);
        ...
        {
            Toast.makeText(user_dbms.this,"Error occured!Try Again",Toast.LENGTH_SHORT).show();
        }
                    ...
                    public void onClick(View v) {
                        if(i<5) {
                            ...
                            if (result.equals(cu.getString(6))) {
                                mark_dbms=mark_dbms+5;
                                count_dbms++;
                                Toast.makeText(user_dbms.this, "Secured=5", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                Toast.makeText(user_dbms.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
                            }
                            i++;
                            if(k<5)
                            {
                        ...
                        {
                            Intent j=new Intent(user_dbms.this,result_dbms.class);
                            int id = rg.getCheckedRadioButtonId();
                            res = (RadioButton) findViewById(id);
                            Cursor cu = ob.info_dbms(i);
                            cu.moveToFirst();
        ...
        skip.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(user_dbms.this, "You skipped this question", Toast.LENGTH_SHORT).show();
                        i++;
                        if(k<5)
                        {
                            try {
